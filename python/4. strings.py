...
# Trying to change a character# Example 1: Creating and Using Strings directly will raise a TypeError
...
# Define a string containing biodata
Biodata = "Name: SHAMS, Age: 23, Country: BANGLADESH"

# Split the string into pieces of information
pieces = Biodata.split(', ')

# Extract and print each piece of information separately
for piece in pieces:
...
greeting_concatenation = "Hello, my name is " + name + " and I am " + str(age) + " years old."
...
# Test the function
input_string = "Hello, Python enthusiasts!"
