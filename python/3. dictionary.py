...
student = {'name': 'shams', 'roll_number': 'C193267', 'grades': {'ML': 75, 'NN': 90, 'IP': 60}}
...
print("ML Grade:", student['grades']['ML'])

# Updating elements
student['grades']['NN'] = 95  # Update science grade
student['grades']['IP'] = 80  # Add English grade
print("Updated Student Dictionary:")
print(student)

# Removing elements
removed_grade = student['grades'].pop('IP')  # Remove history grade
print("Removed History Grade:", removed_grade)
print("Student Dictionary after removing history grade:")
print(student)

# Adding elements
student['address'] = 'muradpur Street'  
print("Student Dictionary after adding address:")
print(student)
